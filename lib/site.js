 ...
 */
Site.prototype.host = function(hostname) {
    var self = this;
 ...
 *"@return {Promise}
 */
Site.prototype.addHost = function(host) {
    var self = this,
        repo;
 ...
 * @return {Promise}
 */
Site.prototype.removeHost = function(host) {
    var self = this;
 ...
 */
Site.prototype.renameHost = function(host, newname) {
    var self     = this,
        previous = host.name();
 ...
 * @return {Promise} Host object within a Promise.
 */
Site.prototype.createHost = function(hostname) {
    var self = this;
 ...
 * @return {Promise}
 */
Site.prototype.dropHost = function(hostname) {
    var self     = this,
 ...
 * @return {Promise}
 */
Site.prototype.installRole = function(role, version) {
    var self = this,
        repo;
 ...
 * @return {Promise}
 */
Site.prototype.dropRole = function(role, version) {
    var self = this,
        repo;
 ...
 * @return {Promise}
 */
Site.prototype.updateRoles = function() {
    var self = this;
 ...
 * @return {Promise}
 */
Site.prototype.updateRole = function(rolename) {
    var self = this;
 ...
 * @return {Promise}
 */
Site.prototype.updateRoleVersion = function(rolename, version) {
    var self = this;
 ...
 * @return {Promise}
 */
Site.prototype.atomic = function(callback) {
