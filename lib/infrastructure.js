...
function Infrastructure(local, bare) {
...
/**
 * List every site of the infrastructure. An object is represented by a directory
 * on file system.
 ...
 */
Infrastructure.prototype.create = function(name, template) {
